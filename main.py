...
if selected == "BirdSong": 
    ...
    st.markdown("<b><p style='color:black;font-size:20px;background:rgba(255,255,255,0.20);border-radius:12px;padding:10px 14px;'>This app groups birds based on their birdsong. Select how many clusters you want to observe within the ~400 audios from Xeno Canto.</p></b>",
                unsafe_allow_html=True)
