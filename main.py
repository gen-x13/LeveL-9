...
if selected == "BirdSong Example": 
    ...
    st.markdown("<b><p style='color:black;font-size:20px;'>This app groups birds based on their birdsong (frequency, amplitude, similarity).</p> <p style='color:black;font-size:20px;'>Select how many clusters you want to observe within the ~400 audios from Xeno Canto.</p></b>",
                unsafe_allow_html=True)
